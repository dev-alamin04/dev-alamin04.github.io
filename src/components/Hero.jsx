    ...
    <section id="home" className="hero">
      <div className="container relative z-10">
        <div className="hero-content">
          ...
          >
            <span className="typed-text text-xl md:text-2xl font-medium" style={{ color: 'var(--gray)' }}>Full Stack Web Developer</span>
          </motion.div>
          ...
          >
            <Link to="projects" smooth={true} duration={500} style={{ padding: '12px 28px', background: 'var(--gradient)', color: '#fff', borderRadius: '50px', fontWeight: 600, boxShadow: 'var(--shadow-lg)' }}>
              View My Work
            </Link>
            <Link to="contact" smooth={true} duration={500} style={{ padding: '12px 28px', background: 'transparent', color: 'var(--primary)', border: '2px solid var(--primary)', borderRadius: '50px', fontWeight: 600 }}>
              Contact Me
            </Link>
          </motion.div>
